...
const BlogPostCard: React.FC<BlogPostCardProps> = ({ post }) => {
  ...
  return (
    ...
    >
      ...
      <div className="group relative bg-black/95 backdrop-blur-xl rounded-xl border border-white/10 hover:border-[#ff0abe]/50 transition-all duration-300 overflow-visible min-h-[400px]">
        {isLoading ? (
