  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className="flex items-center gap-1">
        <NavigationMenuItem>
          <Link 
            to="/maker-space/builds"
            className="h-9 px-4 py-2 group/nav-trigger bg-transparent text-white hover:bg-gradient-to-r hover:from-[#41f0db]/20 hover:to-[#8000ff]/20 hover:text-[#41f0db] transition-all duration-300 flex items-center"
          >
