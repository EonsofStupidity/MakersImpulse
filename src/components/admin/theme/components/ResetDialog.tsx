      ...
      <DialogContent className="bg-gray-800/95 border border-red-500/20">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">
            ...
            This action cannot be undone. Type RESET and check the box to confirm.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="reset-confirmation" className="text-white">Type RESET to confirm</Label>
            <Input
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button
              variant="destructive"
              onClick={onReset}
              disabled={isResetting || !confirmCheckbox || resetConfirmation !== "RESET"}
            >
              {isResetting ? (
                <>
