      ...
      <AccordionContent className="space-y-4 pt-4">
        <div className="grid gap-4">
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("border_radius", String(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("spacing_unit", String(value))}
          ...
          <CSSEffectsControl
            ...
            max={1}
            step={0.1}
            onChange={(value) => form.setValue("transition_duration", String(value))}
