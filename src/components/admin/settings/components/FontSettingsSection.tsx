      ...
      <AccordionContent className="space-y-4 pt-4">
        <div className="grid gap-4">
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("font_family_heading", handleValueChange(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("font_family_body", handleValueChange(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("font_size_base", handleValueChange(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("font_weight_normal", handleValueChange(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("font_weight_bold", handleValueChange(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("line_height_base", handleValueChange(value))}
          ...
          <CSSEffectsControl
            ...
            onChange={(value) => form.setValue("letter_spacing", handleValueChange(value))}
